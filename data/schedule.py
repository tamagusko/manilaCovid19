...
def prepare_google_data():
    ...
    df.to_csv("google_data_processed.csv")
    return print(CURRENT_TIME + ": Google data processed", file=open("log.txt", "a"))
...
def prepare_apple_data():
    ...
    df.to_csv("apple_data_processed.csv")
    return print(CURRENT_TIME + ": Apple data processed", file=open("log.txt", "a"))
